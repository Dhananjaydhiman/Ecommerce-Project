            ...
            <div className='container-fluid'>
               <div className='row text-center '>
                  ...
                  {filterProduct.map((element) => {
                     return (
                        <div className='col-10 col-md-4 mt-3' key={element.id}>
...
//                   {filterProduct.map((element) => {
//                      return (
//                         <div className='col-10 col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-3' key={element.id}>
//                            <div className='card p-2' style={{ background: "white" }}>
//                               <div className=' image ' style={{ height: "350px" }}>
//                                  <img src={element.thumbnail} className='round img-fluid' alt='img' />
//                               </div>
//                               <div className='mt-3 mx-3' style={{ textAlign: "left" }}>
//                                  <div className=' w-100'> <h4>{element.title}</h4> </div>
//                                  <div className='d-flex'>
